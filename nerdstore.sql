...
-- Copiando dados para a tabela trabalho_av2.compra: ~6 rows (aproximadamente)
...
-- Copiando dados para a tabela trabalho_av2.produto: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `produto` DISABLE KEYS */;
INSERT INTO `produto` (`ID`, `NOME`, `PRECO`, `DESCRICAO`, `URL_IMAGEM`) VALUES
	(1, 'Caneca Tom Super Mario Bros', 59, 'O encanador mais famoso dos games agora na caneca!', 'https://uploads.nerdstore.com.br/wp-content/uploads/2020/08/caneca-tom-super-mario-02-300x300.jpg'),
...
-- Copiando dados para a tabela trabalho_av2.usuario: ~3 rows (aproximadamente)
